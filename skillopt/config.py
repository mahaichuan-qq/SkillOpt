...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "model.qwen_chat_stream": "qwen_chat_stream",
    ...
    "model.optimizer_qwen_chat_stream": "optimizer_qwen_chat_stream",
    ...
    "model.target_qwen_chat_stream": "target_qwen_chat_stream",
